...
import '/views/widgets/homepage_widgets.dart';
...
class LiveMatchDetails extends StatefulWidget {
  const LiveMatchDetails(this.liveMatch, this.check, {Key? key})
      : super(key: key);
  final Ft liveMatch;
  final bool check;
  @override
...
class _LiveMatchDetailsState extends State<LiveMatchDetails>
  ...
  void initState() {
    super.initState();
    matchDetailsController.loadHeader(widget.liveMatch.gameId.toString());
    matchDetailsController.loadStatistics(widget.liveMatch.gameId.toString());
    ...
    _tabController!.addListener(
      () {
        ...
        if (index == 0 || type == 'Statistics') {}
        if (index == 1 || type == 'Line-Up') {
          matchDetailsController.loadlineup(widget.liveMatch.gameId.toString());
        }
        if (index == 2 || type == 'Commentary') {
          matchDetailsController
              .loadCommentary(widget.liveMatch.gameId.toString());
        }
      },
    );
  }
            ...
            body: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() => !matchDetailsController.ismatchHeaderLoading.value
                      ? Stack(
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                    child: widget.check
                                        ? GlobalText(
                                            matchDetailsController.header.value
                                                    .data!.gameTime ??
                                                "",
                                            AppSizes.size16,
                                            FontWeight.normal,
                    ...
                    child: AppBar(
                      ...
                      bottom: TabBar(
                        ...
                        onTap: (v) {
                          ...
                          if (v == 1) {
                            matchDetailsController
                                .loadlineup(widget.liveMatch.gameId.toString());
                          }
                          if (v == 2) {
                            matchDetailsController.loadCommentary(
                                widget.liveMatch.gameId.toString());
                          }
                        },
                  ...
                  Expanded(
                    child: TabBarView(
                      ...
                      children: [
                        RefreshIndicator(
                            onRefresh: () async {
                              matchDetailsController.loadHeader(
                                  widget.liveMatch.gameId.toString());
                              matchDetailsController.loadStatistics(
                                  widget.liveMatch.gameId.toString());
                            },
                            child: MatchStats(widget.liveMatch)),
                        //Container(),
                        RefreshIndicator(
                          onRefresh: () async {
                            matchDetailsController
                                .loadHeader(widget.liveMatch.gameId.toString());
                            matchDetailsController
                                .loadlineup(widget.liveMatch.gameId.toString());
                          },
                          child: const MatchLineUp(),
                        ),
                        RefreshIndicator(
                          onRefresh: () async {
                            matchDetailsController
  ...
  showbutton(String option) {
    return InkWell(
      onTap: () {
        ...
        //  log(widget.liveMatch.gameId.toString());
        setState(() {
          type = option;
        });
      },
